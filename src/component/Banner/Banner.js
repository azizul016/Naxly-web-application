  ...
  return (
    <section className='banner-section'>
      <div className='pattern-layer'>
        ...
        //   style='background-image: url(assets/images/shape/shape-55.png);'
        ></div>
      </div>
      <div className='icon-layer'>
        ...
        //   style='background-image: url(assets/images/icons/wheel-2.png);'
        ></div>
        <div
          className='icon icon-2 rotate-me'
          style={{backgroundImage: `url(${wheel3})` }}
        //   style='background-image: url(assets/images/icons/wheel-3.png);'
        ></div>
        <div
          className='icon icon-3 rotate-me'
          style={{backgroundImage: `url(${wheel4})` }}
        //   style='background-image: url(assets/images/icons/wheel-4.png);'
        ></div>
        <div
          className='icon icon-4 rotate-me'
          style={{backgroundImage: `url(${wheel5})` }}
        //   style='background-image: url(assets/images/icons/wheel-5.png);'
        ></div>
      </div>
